...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Monu0777/Maxmusic")
...
YOUTUBE_IMG_URL = "https://telegra.ph/file/cb02eadfceb1e13e38da0.png"
...
SPOTIFY_PLAYLIST_IMG_URL = "https://telegra.ph/file/cb02eadfceb1e13e38da0.png"
...
if PING_IMG_URL:
    if PING_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://telegra.ph/file/d0a6759ae76fcd5f6cf63.jpg"

if START_IMG_URL:
    if START_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://telegra.ph/file/b4ebbe5275f1f8a44671b.jpg"
