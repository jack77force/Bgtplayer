    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            if (
                ...
                return await mystic.edit_text(
                    "𝐓𝐡𝐢𝐬 𝐁𝐨𝐭 𝐂𝐚𝐧'𝐭 𝐏𝐥𝐚𝐲 𝐒𝐩𝐨𝐭𝐢𝐟𝐲 𝐓𝐫𝐜𝐤𝐬 𝐨𝐫 𝐏𝐥𝐚𝐲𝐥𝐢𝐬𝐭𝐬 𝐑𝐞𝐩𝐨𝐫𝐭 [𝐃𝐞𝐯𝐢𝐥](https://t.me/About_Info_Devil)."
                )
            if "track" in url:
                try:
            ...
            try:
                ...
                await mystic.edit_text(
                    "There's An Error In The Bot Then Report [𝐃𝐞𝐯𝐢𝐥](https://t.me/About_Info_Devil) AN Error"
                )
